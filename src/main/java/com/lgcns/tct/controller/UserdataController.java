...
public class UserdataController {
	...
	public List<UsedListDto> getUsedList(@PathVariable("user_no")String user_no , @RequestParam("ptype")int ptype ) {
		
		//🔨🔨이곳에 코드를 작성하세요!
		String start_dt = getStartDate(ptype);

		List<UsedListDto> result = usedataService.getUsedList(user_no, start_dt);
